...
<body class="body">
    <nav>
      ...
      <li class="nav-item">
        <a class="nav-link" href="others.php">OTHER</a>
            ...
            <li class="nav-item">
                <a href="login.php"><button type="button" class="btn btn-outline-primary button">Login</button></a>
            </li>
        </ul>
    </nav>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "INSERT INTO `account` ( `name`, `mobile`, `dob`, `age`, `gender`, `State`, `country`, `pin`, `email`, `at`) VALUES ( '$name', '$tel', '$dob', '$age', '$gender', '$state', '$country', '$pin', '$email', current_timestamp())";

        $result = mysqli_query($conn, $sql);

        if ($result) {
            echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Hello ' . $name . '</strong> welcome to our online store &#x1F600;
    ...
    <div class="acform">
        <form method="POST" action="ac.php">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="tel" name="tel" placeholder="Enter your mobile numer"
                    required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="pin" name="pin" placeholder="Enter your area pin code"
                    required>
            </div>
